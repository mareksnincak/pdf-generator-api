...
> Key design decisions including alternatives considered and tradeoffs are documented as [Architecture decision records](docs/architecture-decision-records/).
